...
const ModeratorModalUpdate = ({
  ...
  useEffect(() => {
    holidayData && setHolidayText(holidayData.name);
    holidayData && setSelectedColor(holidayData.color);
    holidayData && setDateHoliday(holidayData.date);
  }, [holidayData]);
...
export default ModeratorModalUpdate;
