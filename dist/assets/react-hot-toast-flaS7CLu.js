...
to {
  ...
  animation: ${K} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,et=({toast:t})=>{let{icon:e,type:a,iconTheme:o}=t;return e!==void 0?typeof e=="string"?s.createElement(tt,null,e):e:a==="blank"?null:s.createElement(q,null,s.createElement(V,{...o}),a!=="loading"&&s.createElement(_,null,a==="error"?s.createElement(J,{...o}):s.createElement(Z,{...o})))},at=t=>`
...
`,v=16,yt=({reverseOrder:t,position:e="top-center",toastOptions:a,gutter:o,children:i,containerStyle:r,containerClassName:l})=>{let{toasts:n,handlers:p}=R(a);return s.createElement("div",{style:{position:"fixed",zIndex:9999,top:v,left:v,right:v,bottom:v,pointerEvents:"none",...r},className:l,onMouseEnter:p.startPause,onMouseLeave:p.endPause},n.map(d=>{let h=d.position||e,k=p.calculateOffset(d,{reverseOrder:t,gutter:o,defaultPosition:e}),b=pt(h,k);return s.createElement(ct,{id:d.id,key:d.id,onHeightUpdate:p.updateHeight,className:d.visible?ut:"",style:b},d.type==="custom"?$(d.message,d):i?i(d):s.createElement(dt,{toast:d,position:h}))}))};export{yt as I,c as n};
